...
public class BlobDetection {
        ...
        public static class Blob
        {
                ...
                /**
                 * This returns formatted data to be processed in the 
                 */
                public String toString()
                {
                        return String.format("%4d,%4d,%4d,%4d", xMin, xMax, yMin, yMax);
                }
        }

        /**
         * This method initiates the Bitmap to be processed
         * @param bitmap
         */
        ...
        /**
         * This method locates the blobs on the 
         * bitmap and returns an image with green colored blobs
         * @param bitmap
         * @return
         */
